      ...
      <div className="grid items-stretch gap-5 lg:grid-cols-3">
        {landingBookExamples.map((book) => (
          <button
            ...
            className="group grid h-full min-h-[194px] cursor-pointer grid-cols-[148px_1fr] gap-4 rounded-[24px] border border-[#e9ebf4] bg-white p-3 text-left shadow-[0_18px_48px_rgba(15,23,42,0.055)] transition hover:-translate-y-1 hover:border-[#cfd3e1] hover:shadow-[0_24px_68px_rgba(15,23,42,0.09)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#ff6257]"
            style={
              {
          ...
          >
            <div className="relative flex min-h-[170px] items-center justify-center overflow-hidden rounded-lg bg-[linear-gradient(145deg,var(--book-wash),#fff)] px-3 py-4">
              <PremiumBookCover
                book={book}
                size="demo"
                className="max-w-[112px] transition duration-300 group-hover:-translate-y-1 group-hover:rotate-[-2deg]"
              />
            </div>
